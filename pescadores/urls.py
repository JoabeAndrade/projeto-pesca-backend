...
urlpatterns = [
    ...
    path('telefones/', views.TelefoneList.as_view(), name='telefone_list'),
    path('telefones/<int:pk>', views.TelefoneDetail.as_view(), name='telefone_detail'),
    ...
    path('portos/', views.PortoList.as_view(), name='porto_list'),
